...
const createWindCard = wind => {
  ...
  card.append((0,_elements_helperFunc__WEBPACK_IMPORTED_MODULE_0__.setContent)('windMax', `Max Speed: ${max}`));
...
/***/ "./src/components/display/cardSections/loadingCard.js":
/*!************************************************************!*\
  !*** ./src/components/display/cardSections/loadingCard.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createLoadingCard: () => (/* binding */ createLoadingCard)
/* harmony export */ });
...
const createTodaySection = _ref => {
  ...
  const highestTemp = (0,_elements_helperFunc__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)('h3', 'highTemp', `H: ${temp.c.max}°C`);
  todaySection.append(highestTemp);
  const lowTemp = (0,_elements_helperFunc__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)('h3', 'lowTemp', `L: ${temp.c.min}°C`);
...
const getFormattedDate = dateString => {
  ...
  const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date, 'EEEE');
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date) ? 'Today' : formattedDate;
};
const createWeatherNode = async (weatherData, isHourly) => {
  ...
  let nodeTitle = isHourly ? weatherData.hour : getFormattedDate(weatherData.date);
  ...
  weatherNode.append((0,_helperFunc__WEBPACK_IMPORTED_MODULE_0__.createElementWithClass)('h4', 'nodeTitle', nodeTitle));
  ...
  if (isHourly) {
    ...
    weatherNode.append((0,_helperFunc__WEBPACK_IMPORTED_MODULE_0__.setContent)('avgTemp', `Avg: ${temp.c.avg}°C`));
    weatherNode.append((0,_helperFunc__WEBPACK_IMPORTED_MODULE_0__.setContent)('maxTemp', `Max: ${temp.c.max}°C`));
    weatherNode.append((0,_helperFunc__WEBPACK_IMPORTED_MODULE_0__.setContent)('minTemp', `Min: ${temp.c.min}°C`));
  }
  return weatherNode;
};
...
const getGeolocation = async callback => {
  ...
  navigator.geolocation.getCurrentPosition(successCallback, errorCallback).then(response => console.log(response));
};
...
/* harmony export */ });
/* harmony import */ var _searchBarElement__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./searchBarElement */ "./src/components/searchBar/searchBarElement.js");

const searchBar = async callback => {
  const searchForm = (0,_searchBarElement__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/***/ "./src/components/searchBar/searchBarElement.js":
/*!******************************************************!*\
  !*** ./src/components/searchBar/searchBarElement.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _services_filterData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/filterData */ "./src/services/filterData.js");


const getWeather = async location => {
  const weatherData = await (0,_services_weatherapi__WEBPACK_IMPORTED_MODULE_0__["default"])(location);
  const cleanData = await (0,_services_filterData__WEBPACK_IMPORTED_MODULE_1__["default"])(weatherData);
  return cleanData;
};
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/SF-Pro-Rounded-Regular.otf */ "./src/assets/fonts/SF-Pro-Rounded-Regular.otf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/SF-Pro-Rounded-Bold.otf */ "./src/assets/fonts/SF-Pro-Rounded-Bold.otf"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ./assets/fonts/SF-Pro-Rounded-Light.otf */ "./src/assets/fonts/SF-Pro-Rounded-Light.otf"), __webpack_require__.b);
...
/* harmony import */ var _components_display_cardSections_loadingCard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/display/cardSections/loadingCard */ "./src/components/display/cardSections/loadingCard.js");
...
const displayWeather = async searchResult => {
  ...
  const loadingCard = (0,_components_display_cardSections_loadingCard__WEBPACK_IMPORTED_MODULE_6__.createLoadingCard)();
  ...
  const weatherData = await (0,_components_weather__WEBPACK_IMPORTED_MODULE_3__["default"])(searchResult);

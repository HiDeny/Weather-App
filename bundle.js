  ...
  getWeather = (() => {
    ...
    return async function () {
      ...
      try {
        ...
        console.log(rawData);
        const cleanData = (0,_model_data_filter_filterWeatherData__WEBPACK_IMPORTED_MODULE_1__["default"])(rawData, _this.isMetric);
...
const filterWeatherData = function (rawData) {
  ...
  try {
    ...
    const today = (0,_filterToday__WEBPACK_IMPORTED_MODULE_0__["default"])(rawData, isMetric);
    const upcoming = (0,_filterUpcoming__WEBPACK_IMPORTED_MODULE_1__["default"])(rawData, isMetric);
    return {
      location,
      today,
      upcoming

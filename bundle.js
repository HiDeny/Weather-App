...
.weatherCard {
  display: grid;
  grid-template-rows: 8rem 12rem 30rem 15rem;
  gap: 5%;
  /* height: 50rem; */
  margin: auto;
}
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,qCAAqC;EACrC,+DAAwE;AAC1E;;AAEA;EACE,kCAAkC;EAClC,+DAAqE;AACvE;;AAEA;EACE,mCAAmC;EACnC,+DAAsE;AACxE;;AAEA;EACE,gDAAgD;AAClD;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,aAAa;AACf;;AAEA;EACE,mBAAmB;EACnB,eAAe;EACf,oCAAoC;EACpC,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,SAAS;AACX;;AAEA;EACE,mBAAmB;EACnB,sBAAsB;EACtB,iBAAiB;AACnB;;;AAGA;EACE,aAAa;EACb,0CAA0C;EAC1C,OAAO;EACP,mBAAmB;EACnB,YAAY;AACd;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,YAAY;;EAEZ,iBAAiB;EACjB,mBAAmB;AACrB;;AAEA;EACE,SAAS;;EAET,iBAAiB;EACjB,gBAAgB;EAChB,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,oCAAoC;EACpC,8BAA8B;EAC9B,uBAAuB;EACvB,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,SAAS;;EAET,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,iBAAiB;EACjB,mBAAmB;EACnB,SAAS;EACT,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,sBAAsB;EACtB,kBAAkB;EAClB,SAAS;EACT,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,WAAW;EACX,8BAA8B;EAC9B,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,YAAY;EACZ,SAAS;EACT,aAAa;EACb,aAAa;AACf;;AAEA;EACE,aAAa;EACb,kCAAkC;EAClC,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;EACnB,8BAA8B;EAC9B,mBAAmB;AACrB","sourcesContent":["@font-face {\n  font-family: 'SF-Pro-Rounded-Regular';\n  src: url('./assets/fonts/SF-Pro-Rounded-Regular.otf') format('opentype');\n}\n\n@font-face {\n  font-family: 'SF-Pro-Rounded-Bold';\n  src: url('./assets/fonts/SF-Pro-Rounded-Bold.otf') format('opentype');\n}\n\n@font-face {\n  font-family: 'SF-Pro-Rounded-Light';\n  src: url('./assets/fonts/SF-Pro-Rounded-Light.otf') format('opentype');\n}\n\nhtml {\n  font-family: 'SF-Pro-Rounded-Regular', Helvetica;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: 5rem auto;\n  height: 100vh;\n}\n\nsection {\n  background: #f0f0f0;\n  padding: 1rem 0;\n  border: 1px solid rgb(116, 116, 116);\n  border-radius: 1rem;\n}\n\n.searchForm {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  gap: 1rem;\n}\n\n#searchBar {\n  border-radius: 1rem;\n  border: 1px solid gray;\n  padding: 5px 10px;\n}\n\n\n.weatherCard {\n  display: grid;\n  grid-template-rows: 8rem 12rem 30rem 15rem;\n  gap: 5%;\n  /* height: 50rem; */\n  margin: auto;\n}\n\n.info {\n  text-align: center;\n}\n\n.locationName {\n  margin: 1rem;\n\n  font-size: 1.6rem;\n  letter-spacing: 1px;\n}\n\n.locationRegion {\n  margin: 0;\n\n  font-size: 0.9rem;\n  font-weight: 300;\n  font-style: normal;\n  letter-spacing: 1px;\n}\n\n.today {\n  display: grid;\n  grid-template-rows: 4rem 3rem 2.5rem;\n  grid-template-columns: 1fr 1fr;\n  justify-content: center;\n  text-align: center;\n}\n\n.today > .currentTemp {\n  font-size: 3em;\n  margin: 0;\n\n  grid-column: 1 / 3;\n  align-self: center;\n}\n\n.conditionsDesc {\n  grid-column: 1 / 3;\n  font-size: 1.2rem;\n  margin: 1rem;\n  align-self: center;\n}\n\n.today > .highTemp {\n  justify-self: end;\n  padding-right: 1rem;\n  margin: 0;\n  align-self: center;\n  font-size: 1rem;\n}\n\n.today > .lowTemp {\n  justify-self: baseline;\n  padding-left: 1rem;\n  margin: 0;\n  align-self: center;\n  font-size: 1rem;\n}\n\n.daysForecast {\n  display: flex;\n  gap: 0.3rem;\n  justify-content: space-between;\n  padding: 0 0.5rem;\n}\n\n.hourForecast {\n  overflow-y: scroll;\n  width: 50rem;\n  gap: 1rem;\n  padding: 1rem;\n  display: flex;\n}\n\n.forecast {\n  display: grid;\n  grid-template-rows: repeat(2, 1fr);\n  gap: 0.5rem;\n  align-items: center;\n}\n\n.detailsSection {\n  display: grid;\n  justify-content: space-evenly;\n  align-items: center;\n  grid-template-columns: 1fr 1fr;\n  grid-auto-flow: row;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
